    ...
    <ReceptionistLayout>
      <View style={styles.container}>
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Process patient discharges and summaries</Text>
        </View>
        <ScrollView>
          <View style={styles.infoBox}>
            <Text style={styles.infoText}>Finalize patient discharge documentation and billing clearance.</Text>
          </View>
        </ScrollView>
      </View>
    </ReceptionistLayout>
